...
#define DISTANCE_BETWEEN_SENSORS_MM 105 
...
CH201_dev dev1(Wire, CHIRP_DEVICE1_I2C_ADDR, 3, 8, 11);
...
void setup() {
  ...
  ret = CHx01.start_trigger(1500);
  if (ret != 0) {
    Serial.print("CH201 trig start failed: ");
    Serial.println(ret);
    while (1)
      ;
  } else {
